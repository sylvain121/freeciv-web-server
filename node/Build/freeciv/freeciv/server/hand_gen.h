...
void handle_nation_select_req(struct connection *pc, int player_no, int nation_no, bool is_male, const char *name, int city_style);
...
void handle_unit_change_activity_base(struct player *pplayer, int unit_id, enum unit_activity activity, Base_type_id activity_base);
void handle_unit_change_activity_road(struct player *pplayer, int unit_id, enum unit_activity activity, Road_type_id activity_road);
...
void handle_scenario_info(struct connection *pc, const struct packet_scenario_info *packet);
...
void handle_edit_tile_special(struct connection *pc, int tile, enum tile_special_type special, bool remove, int size);
void handle_edit_tile_base(struct connection *pc, int tile, Base_type_id base_type_id, bool remove, int size);
void handle_edit_tile_road(struct connection *pc, int tile, Road_type_id road_type_id, bool remove, int size);
...
void handle_info_text_req(struct player *pplayer, int loc, int visible_unit);
