...
void handle_diplomacy_create_clause(int counterpart, int giver, enum clause_type clause_type, int value);
void handle_diplomacy_remove_clause(int counterpart, int giver, enum clause_type clause_type, int value);
...
void handle_conn_ping_info(int connections, const int *conn_id, const int *ping_time);
