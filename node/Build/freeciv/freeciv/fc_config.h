/* fc_config.h.  Generated from fc_config.h.in by configure.  */
/* fc_config.h.in.  Generated from configure.ac by autoheader.  */
...
#define FC_STORE_CFLAGS '-Wall -Wpointer-arith -Wcast-align -g -O2 -fsigned-char -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  '

/* These are the CPPFLAGS used in compilation */
#define FC_STORE_CPPFLAGS ' -DLOCALEDIR="\"${datarootdir}/locale\"" -DBINDIR="\"${exec_prefix}/bin\"" -DFC_CONF_PATH="\"${prefix}/etc/freeciv\"" -DDEFAULT_DATA_PATH="\".:data:~/.freeciv/dev:${datarootdir}/freeciv\"" -DDEFAULT_SAVES_PATH="\"\"" -DDEFAULT_SCENARIO_PATH="\".:data/scenarios:~/.freeciv/dev/scenarios:~/.freeciv/scenarios:${datarootdir}/freeciv/scenarios\""'
...
#define NETWORK_CAPSTRING_MANDATORY "+Freeciv.Web.Devel-2.6-2013.May.25"
...
#define VERSION "2.5.99-dev"

/* Version label */
#define VERSION_LABEL "-dev"

/* Version string */
#define VERSION_STRING "2.5.99-dev"
