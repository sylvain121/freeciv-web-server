                          ...
                          struct player *pplayer, struct connection *pconn)
{
  ...
  case PACKET_DIPLOMACY_CREATE_CLAUSE_REQ:
    handle_diplomacy_create_clause_req(pplayer,
      ...
      ((const struct packet_diplomacy_create_clause_req *)packet)->clause_type,
  ...
  case PACKET_DIPLOMACY_REMOVE_CLAUSE_REQ:
    handle_diplomacy_remove_clause_req(pplayer,
      ...
      ((const struct packet_diplomacy_remove_clause_req *)packet)->clause_type,
  ...
  case PACKET_REPORT_REQ:
    handle_report_req(pconn,
      ((const struct packet_report_req *)packet)->report_type);
    return TRUE;
  ...
  case PACKET_INFO_TEXT_REQ:
    handle_info_text_req(pplayer,
      ((const struct packet_info_text_req *)packet)->loc,
      ((const struct packet_info_text_req *)packet)->visible_unit);
    return TRUE;

  case PACKET_GOTO_PATH_REQ:
    handle_goto_path_req(pplayer,
      ((const struct packet_goto_path_req *)packet)->unit_id,
      ((const struct packet_goto_path_req *)packet)->goal);
    return TRUE;
